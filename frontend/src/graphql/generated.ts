...
export const PublicationStatsFieldsFragmentDoc = gql`
  ...
  totalAmountOfComments
    ...
    `;
export const NftOwnershipFieldsFragmentDoc = gql`
  ...
  tokenIds
    ...
    `;
export const EoaOwnershipFieldsFragmentDoc = gql`
    fragment EoaOwnershipFields on EoaOwnershipOutput {
  address
}
    `;
export const Erc20OwnershipFieldsFragmentDoc = gql`
  ...
  decimals
    ...
    `;
export const ProfileOwnershipFieldsFragmentDoc = gql`
    fragment ProfileOwnershipFields on ProfileOwnershipOutput {
  profileId
}
    `;
export const FollowConditionFieldsFragmentDoc = gql`
    fragment FollowConditionFields on FollowConditionOutput {
  profileId
}
    `;
export const CollectConditionFieldsFragmentDoc = gql`
...
export const SimpleConditionFieldsFragmentDoc = gql`
  ...
  collect {
    ...
    `;
export const BooleanConditionFieldsRecursiveFragmentDoc = gql`
  ...
  or {
    ...
    `;
export const AccessConditionFieldsFragmentDoc = gql`
    fragment AccessConditionFields on AccessConditionOutput {
  ...SimpleConditionFields
  ...BooleanConditionFieldsRecursive
}
    `;
export const EncryptedMediaFieldsFragmentDoc = gql`
  ...
  mimeType
    ...
    `;
export const EncryptedMediaSetFieldsFragmentDoc = gql`
...
export const MirrorFieldsFragmentDoc = gql`
  ...
  mirrorOf {
    ...
    `;
export const TxReceiptFieldsFragmentDoc = gql`
...
export const WalletFieldsFragmentDoc = gql`
  ...
  defaultProfile {
    ...
    `;
export const CommonPaginatedResultInfoFieldsFragmentDoc = gql`
  ...
  totalCount
    ...
    `;
export const AndConditionFieldsFragmentDoc = gql`
  ...
  criteria {
    ...
    `;
export const OrConditionFieldsFragmentDoc = gql`
  ...
  criteria {
    ...
    `;
export const AndConditionFieldsNoRecursiveFragmentDoc = gql`
  ...
  criteria {
    ...
    `;
export const OrConditionFieldsNoRecursiveFragmentDoc = gql`
 ...
 *
 * To run a mutation, you first call `useBroadcastMutation` within a Vue component and pass it any options that fit your needs.
 * When your component renders, `useBroadcastMutation` returns an object that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - Several other properties: https://v4.apollo.vuejs.org/api/use-mutation.html#return
 *
 * @param options that will be passed into the mutation, supported options are listed on: https://v4.apollo.vuejs.org/guide-composable/mutation.html#options;
 *
 * @example
 * const { mutate, loading, error, onDone } = useBroadcastMutation({
 *   variables: {
 *     request: // value for 'request'
 *   },
 * });
 */
export function useBroadcastMutation(options: VueApolloComposable.UseMutationOptions<BroadcastMutation, BroadcastMutationVariables> | ReactiveFunction<VueApolloComposable.UseMutationOptions<BroadcastMutation, BroadcastMutationVariables>> = {}) {
  return VueApolloComposable.useMutation<BroadcastMutation, BroadcastMutationVariables>(BroadcastDocument, options);
}
export type BroadcastMutationCompositionFunctionResult = VueApolloComposable.UseMutationReturn<BroadcastMutation, BroadcastMutationVariables>;
 ...
 *
 * To run a query within a Vue component, call `useChallengeQuery` and pass it any options that fit your needs.
 * When your component renders, `useChallengeQuery` returns an object from Apollo Client that contains result, loading and error properties
 ...
 *
 * @example
 * const { result, loading, error } = useChallengeQuery({
 *   request: // value for 'request'
 * });
 */
export function useChallengeQuery(variables: ChallengeQueryVariables | VueCompositionApi.Ref<ChallengeQueryVariables> | ReactiveFunction<ChallengeQueryVariables>, options: VueApolloComposable.UseQueryOptions<ChallengeQuery, ChallengeQueryVariables> | VueCompositionApi.Ref<VueApolloComposable.UseQueryOptions<ChallengeQuery, ChallengeQueryVariables>> | ReactiveFunction<VueApolloComposable.UseQueryOptions<ChallengeQuery, ChallengeQueryVariables>> = {}) {
  return VueApolloComposable.useQuery<ChallengeQuery, ChallengeQueryVariables>(ChallengeDocument, variables, options);
}
export function useChallengeLazyQuery(variables: ChallengeQueryVariables | VueCompositionApi.Ref<ChallengeQueryVariables> | ReactiveFunction<ChallengeQueryVariables>, options: VueApolloComposable.UseQueryOptions<ChallengeQuery, ChallengeQueryVariables> | VueCompositionApi.Ref<VueApolloComposable.UseQueryOptions<ChallengeQuery, ChallengeQueryVariables>> | ReactiveFunction<VueApolloComposable.UseQueryOptions<ChallengeQuery, ChallengeQueryVariables>> = {}) {
  return VueApolloComposable.useLazyQuery<ChallengeQuery, ChallengeQueryVariables>(ChallengeDocument, variables, options);
}
export type ChallengeQueryCompositionFunctionResult = VueApolloComposable.UseQueryReturn<ChallengeQuery, ChallengeQueryVariables>;
 ...
 *
 * To run a query within a Vue component, call `useExplorePublicationsQuery` and pass it any options that fit your needs.
 * When your component renders, `useExplorePublicationsQuery` returns an object from Apollo Client that contains result, loading and error properties
 * you can use to render your UI.
 *
 * @param variables that will be passed into the query
 * @param options that will be passed into the query, supported options are listed on: https://v4.apollo.vuejs.org/guide-composable/query.html#options;
 *
 * @example
 * const { result, loading, error } = useExplorePublicationsQuery({
 *   request: // value for 'request'
 * });
 */
export function useExplorePublicationsQuery(variables: ExplorePublicationsQueryVariables | VueCompositionApi.Ref<ExplorePublicationsQueryVariables> | ReactiveFunction<ExplorePublicationsQueryVariables>, options: VueApolloComposable.UseQueryOptions<ExplorePublicationsQuery, ExplorePublicationsQueryVariables> | VueCompositionApi.Ref<VueApolloComposable.UseQueryOptions<ExplorePublicationsQuery, ExplorePublicationsQueryVariables>> | ReactiveFunction<VueApolloComposable.UseQueryOptions<ExplorePublicationsQuery, ExplorePublicationsQueryVariables>> = {}) {
  return VueApolloComposable.useQuery<ExplorePublicationsQuery, ExplorePublicationsQueryVariables>(ExplorePublicationsDocument, variables, options);
}
export function useExplorePublicationsLazyQuery(variables: ExplorePublicationsQueryVariables | VueCompositionApi.Ref<ExplorePublicationsQueryVariables> | ReactiveFunction<ExplorePublicationsQueryVariables>, options: VueApolloComposable.UseQueryOptions<ExplorePublicationsQuery, ExplorePublicationsQueryVariables> | VueCompositionApi.Ref<VueApolloComposable.UseQueryOptions<ExplorePublicationsQuery, ExplorePublicationsQueryVariables>> | ReactiveFunction<VueApolloComposable.UseQueryOptions<ExplorePublicationsQuery, ExplorePublicationsQueryVariables>> = {}) {
  return VueApolloComposable.useLazyQuery<ExplorePublicationsQuery, ExplorePublicationsQueryVariables>(ExplorePublicationsDocument, variables, options);
}
export type ExplorePublicationsQueryCompositionFunctionResult = VueApolloComposable.UseQueryReturn<ExplorePublicationsQuery, ExplorePublicationsQueryVariables>;
 ...
 *
 * To run a mutation, you first call `useCreateFollowTypedDataMutation` within a Vue component and pass it any options that fit your needs.
 * When your component renders, `useCreateFollowTypedDataMutation` returns an object that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - Several other properties: https://v4.apollo.vuejs.org/api/use-mutation.html#return
 *
 * @param options that will be passed into the mutation, supported options are listed on: https://v4.apollo.vuejs.org/guide-composable/mutation.html#options;
 *
 * @example
 * const { mutate, loading, error, onDone } = useCreateFollowTypedDataMutation({
 *   variables: {
 *     request: // value for 'request'
 *   },
 * });
 */
export function useCreateFollowTypedDataMutation(options: VueApolloComposable.UseMutationOptions<CreateFollowTypedDataMutation, CreateFollowTypedDataMutationVariables> | ReactiveFunction<VueApolloComposable.UseMutationOptions<CreateFollowTypedDataMutation, CreateFollowTypedDataMutationVariables>> = {}) {
  return VueApolloComposable.useMutation<CreateFollowTypedDataMutation, CreateFollowTypedDataMutationVariables>(CreateFollowTypedDataDocument, options);
}
export type CreateFollowTypedDataMutationCompositionFunctionResult = VueApolloComposable.UseMutationReturn<CreateFollowTypedDataMutation, CreateFollowTypedDataMutationVariables>;
 ...
 *
 * To run a query within a Vue component, call `useDefaultProfileQuery` and pass it any options that fit your needs.
 * When your component renders, `useDefaultProfileQuery` returns an object from Apollo Client that contains result, loading and error properties
 * you can use to render your UI.
 *
 * @param variables that will be passed into the query
 * @param options that will be passed into the query, supported options are listed on: https://v4.apollo.vuejs.org/guide-composable/query.html#options;
 *
 * @example
 * const { result, loading, error } = useDefaultProfileQuery({
 *   request: // value for 'request'
 * });
 */
export function useDefaultProfileQuery(variables: DefaultProfileQueryVariables | VueCompositionApi.Ref<DefaultProfileQueryVariables> | ReactiveFunction<DefaultProfileQueryVariables>, options: VueApolloComposable.UseQueryOptions<DefaultProfileQuery, DefaultProfileQueryVariables> | VueCompositionApi.Ref<VueApolloComposable.UseQueryOptions<DefaultProfileQuery, DefaultProfileQueryVariables>> | ReactiveFunction<VueApolloComposable.UseQueryOptions<DefaultProfileQuery, DefaultProfileQueryVariables>> = {}) {
  return VueApolloComposable.useQuery<DefaultProfileQuery, DefaultProfileQueryVariables>(DefaultProfileDocument, variables, options);
}
export function useDefaultProfileLazyQuery(variables: DefaultProfileQueryVariables | VueCompositionApi.Ref<DefaultProfileQueryVariables> | ReactiveFunction<DefaultProfileQueryVariables>, options: VueApolloComposable.UseQueryOptions<DefaultProfileQuery, DefaultProfileQueryVariables> | VueCompositionApi.Ref<VueApolloComposable.UseQueryOptions<DefaultProfileQuery, DefaultProfileQueryVariables>> | ReactiveFunction<VueApolloComposable.UseQueryOptions<DefaultProfileQuery, DefaultProfileQueryVariables>> = {}) {
  return VueApolloComposable.useLazyQuery<DefaultProfileQuery, DefaultProfileQueryVariables>(DefaultProfileDocument, variables, options);
}
export type DefaultProfileQueryCompositionFunctionResult = VueApolloComposable.UseQueryReturn<DefaultProfileQuery, DefaultProfileQueryVariables>;
 ...
 *
 * To run a query within a Vue component, call `usePublicationsQuery` and pass it any options that fit your needs.
 * When your component renders, `usePublicationsQuery` returns an object from Apollo Client that contains result, loading and error properties
 * you can use to render your UI.
 *
 * @param variables that will be passed into the query
 * @param options that will be passed into the query, supported options are listed on: https://v4.apollo.vuejs.org/guide-composable/query.html#options;
 *
 * @example
 * const { result, loading, error } = usePublicationsQuery({
 *   request: // value for 'request'
 * });
 */
export function usePublicationsQuery(variables: PublicationsQueryVariables | VueCompositionApi.Ref<PublicationsQueryVariables> | ReactiveFunction<PublicationsQueryVariables>, options: VueApolloComposable.UseQueryOptions<PublicationsQuery, PublicationsQueryVariables> | VueCompositionApi.Ref<VueApolloComposable.UseQueryOptions<PublicationsQuery, PublicationsQueryVariables>> | ReactiveFunction<VueApolloComposable.UseQueryOptions<PublicationsQuery, PublicationsQueryVariables>> = {}) {
  return VueApolloComposable.useQuery<PublicationsQuery, PublicationsQueryVariables>(PublicationsDocument, variables, options);
}
export function usePublicationsLazyQuery(variables: PublicationsQueryVariables | VueCompositionApi.Ref<PublicationsQueryVariables> | ReactiveFunction<PublicationsQueryVariables>, options: VueApolloComposable.UseQueryOptions<PublicationsQuery, PublicationsQueryVariables> | VueCompositionApi.Ref<VueApolloComposable.UseQueryOptions<PublicationsQuery, PublicationsQueryVariables>> | ReactiveFunction<VueApolloComposable.UseQueryOptions<PublicationsQuery, PublicationsQueryVariables>> = {}) {
  return VueApolloComposable.useLazyQuery<PublicationsQuery, PublicationsQueryVariables>(PublicationsDocument, variables, options);
}
export type PublicationsQueryCompositionFunctionResult = VueApolloComposable.UseQueryReturn<PublicationsQuery, PublicationsQueryVariables>;
 ...
 *
 * To run a mutation, you first call `useCreatePostTypedDataMutation` within a Vue component and pass it any options that fit your needs.
 * When your component renders, `useCreatePostTypedDataMutation` returns an object that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - Several other properties: https://v4.apollo.vuejs.org/api/use-mutation.html#return
 *
 * @param options that will be passed into the mutation, supported options are listed on: https://v4.apollo.vuejs.org/guide-composable/mutation.html#options;
 *
 * @example
 * const { mutate, loading, error, onDone } = useCreatePostTypedDataMutation({
 *   variables: {
 *     request: // value for 'request'
 *   },
 * });
 */
export function useCreatePostTypedDataMutation(options: VueApolloComposable.UseMutationOptions<CreatePostTypedDataMutation, CreatePostTypedDataMutationVariables> | ReactiveFunction<VueApolloComposable.UseMutationOptions<CreatePostTypedDataMutation, CreatePostTypedDataMutationVariables>> = {}) {
 ...
 *
 * To run a query within a Vue component, call `useSearchProfilesQuery` and pass it any options that fit your needs.
 * When your component renders, `useSearchProfilesQuery` returns an object from Apollo Client that contains result, loading and error properties
 * you can use to render your UI.
 *
 * @param variables that will be passed into the query
 * @param options that will be passed into the query, supported options are listed on: https://v4.apollo.vuejs.org/guide-composable/query.html#options;
 *
 * @example
 * const { result, loading, error } = useSearchProfilesQuery({
 *   request: // value for 'request'
 * });
 */
export function useSearchProfilesQuery(variables: SearchProfilesQueryVariables | VueCompositionApi.Ref<SearchProfilesQueryVariables> | ReactiveFunction<SearchProfilesQueryVariables>, options: VueApolloComposable.UseQueryOptions<SearchProfilesQuery, SearchProfilesQueryVariables> | VueCompositionApi.Ref<VueApolloComposable.UseQueryOptions<SearchProfilesQuery, SearchProfilesQueryVariables>> | ReactiveFunction<VueApolloComposable.UseQueryOptions<SearchProfilesQuery, SearchProfilesQueryVariables>> = {}) {
  return VueApolloComposable.useQuery<SearchProfilesQuery, SearchProfilesQueryVariables>(SearchProfilesDocument, variables, options);
}
export function useSearchProfilesLazyQuery(variables: SearchProfilesQueryVariables | VueCompositionApi.Ref<SearchProfilesQueryVariables> | ReactiveFunction<SearchProfilesQueryVariables>, options: VueApolloComposable.UseQueryOptions<SearchProfilesQuery, SearchProfilesQueryVariables> | VueCompositionApi.Ref<VueApolloComposable.UseQueryOptions<SearchProfilesQuery, SearchProfilesQueryVariables>> | ReactiveFunction<VueApolloComposable.UseQueryOptions<SearchProfilesQuery, SearchProfilesQueryVariables>> = {}) {
  return VueApolloComposable.useLazyQuery<SearchProfilesQuery, SearchProfilesQueryVariables>(SearchProfilesDocument, variables, options);
}
export type SearchProfilesQueryCompositionFunctionResult = VueApolloComposable.UseQueryReturn<SearchProfilesQuery, SearchProfilesQueryVariables>;
